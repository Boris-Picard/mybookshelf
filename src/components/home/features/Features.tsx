import { WobleCardsFeatures } from "@/components/home/features/WobbleCards";

const Features = () => {
  return (
    <section
      id="features"
      className="lg:py-24 relative mx-auto mt-32 py-12 max-w-[80rem] px-6 text-center md:px-8 sm:h-full h-screen"
    >
