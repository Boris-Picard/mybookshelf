...
export function WobleCardsFeatures() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-6 gap-4 max-w-7xl mx-auto w-full">
      <WobbleCard
        containerClassName="col-span-2 h-full bg-primary/40 "
        className=""
      >
      ...
      <WobbleCard containerClassName="col-span-2 bg-primary/50">
        ...
        <p className="mt-4 max-w-[26rem] text-left text-base/6 text-neutral-200">
          ...
          Marquez les livres comme lus, à lire ou favoris et gardez une trace de
          votre progrès de lecture.
        </p>
      </WobbleCard>
      ...
      <WobbleCard containerClassName="col-span-1 lg:col-span-4 bg-primary/70">
        <div className="max-w-sm">
        ...
        <Image
          ...
          className="absolute -right-10 md:-right-[40%] lg:-right-[15%] -bottom-5 object-contain rounded-2xl"
        />
      </WobbleCard>
      <WobbleCard containerClassName="col-span-2 bg-primary/80">
        <div className="max-w-sm">
          <h2 className="max-w-sm md:max-w-lg  text-left text-balance text-base md:text-xl lg:text-3xl font-semibold tracking-[-0.015em]">
